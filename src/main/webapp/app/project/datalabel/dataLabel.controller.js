...
//                                      document.getElementById("get_content").innerHTML="";
    ...
    function run(_type) {
        ...
        :$scope.timestart,timeend:$scope.timeend,selectoldlabel:$scope.selectoldlabel,oldlabel:$scope.oldlabel,newlabel:$scope.newlabel,type:_type,page:0}, function success(result) {
    ...
    function submit(_type){
        ...
        :$scope.timestart,timeend:$scope.timeend,selectoldlabel:$scope.selectoldlabel,oldlabel:$scope.oldlabel,newlabel:$scope.newlabel,type:_type,page:page}, function success(result) {
        $('#waitModal').modal('hide');
        $('#myModal').modal('show');
        console.log(result);

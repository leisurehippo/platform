...
PsoLocalController.$inject = ['$scope', '$http', '$state', 'upLoad'];
function PsoLocalController($scope, $http, $state, upLoad) {
    var vm = this;
    var obt ={
...
//     }）
    ...
    var uploadTools = {
        ...
        "uploadFile":function(opt){
            ...
            if(uploadUrl!="#"&&uploadUrl!=""){
                ...
                // upLoad.post({file:formData}, {}, function (result) {
                //
                // }, function (result) {
                //
                // });
   ...
   vm.showUpload = showUpload();
    ...
    function initUpload(opt) {
        if (typeof opt != "object") {
            alert('参数错误!');
            return;
        }
        var uploadId="fileUploadContent";

...
AllFileAlController.$inject = ['$scope', '$http', '$state', 'GetAllData', 'GetAlgorithmData', 'HdfsUpload'];
function AllFileAlController($scope, $http, $state, GetAllData, GetAlgorithmData, HdfsUpload) {
    var vm = this;
    vm.fileData = [];
    vm.algrithmData = [];

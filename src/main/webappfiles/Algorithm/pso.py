...
if __name__ == "__main__":
    ...
    HH = np.loadtxt("src/main/webappfiles/Data/HH.dat", dtype=np.float64, delimiter=',')
    QU = np.loadtxt("src/main/webappfiles/Data/QU.dat", dtype=np.float64, delimiter=',')
    SP = np.loadtxt("src/main/webappfiles/Data/SP.dat", dtype=np.float64)

...
import com.bisaibang.monojwt.repository.AuthorityRepository;
import com.bisaibang.monojwt.repository.UserRepository;
import com.bisaibang.monojwt.security.AuthoritiesConstants;
...
public class UserService {
    ...
    public User createUserInformation(String login, String password, String firstName, String lastName, String email,
                                      String nickName, String phone, String confirmCode, String langKey) {
        ...
        langKey = StringEscapeUtils.escapeSql(langKey);
        ...
        // new people gets initially a generated password
        newUser.setPassword(encryptedPassword);
        newUser.setFirstName(firstName);
        newUser.setLastName(lastName);
        newUser.setEmail(email);
        newUser.setPhone(phone); //bsb v2
        newUser.setConfirmCode(confirmCode);
        newUser.setLangKey(langKey);
        newUser.getDefaultAvatar();
        // new people is not active
        newUser.setActivated(true); //bsb v2
        // new people gets registration key
        newUser.setActivationKey(RandomUtil.generateActivationKey());
        authorities.add(authority);
        newUser.setAuthorities(authorities);
        userRepository.save(newUser);

...
(function () {
    ...
    angular
        .module('bsbmsoneApp')
        .controller('DashboardManageCommunicateSectionController', DashboardManageCommunicateSectionController);

    DashboardManageCommunicateSectionController.$inject = ['$scope', '$state', 'forumsGetAllThread', 'ParseLinks', 'AlertService', 'PaginationUtil',
    ...
    function DashboardManageCommunicateSectionController( $scope, $state, forumsGetAllThread, ParseLinks, AlertService, PaginationUtil,
                                                          paginationConstants, ThreadsBatchDelete, createThread, ThreadEditTop, ChangeThreadsColor, forumsGetAllThreadByState, SweetAlert) {
        var vm = this;
        vm.page = 1;
        // vm.selected = [];
        ...
        $scope.$watch('vm.refresh',function () {
            if (vm.refresh == 'manageCommunicateSection') {
                loadAll();

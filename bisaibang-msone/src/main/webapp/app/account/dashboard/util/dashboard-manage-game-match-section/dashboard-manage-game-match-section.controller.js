...
(function () {
    ...
    angular
        .module('bsbmsoneApp')
        .controller('ManageGameMatchSectionController', ManageGameMatchSectionController);

    ManageGameMatchSectionController.$inject = ['$scope', '$state', 'ParseLinks', 'AlertService', 'PaginationUtil', 'paginationConstants', 'ThreadsBatchDelete',
                                                'createThread', 'ThreadEditTop', 'ChangeThreadsColor', 'forumsGetAllThreadByState', 'SweetAlert'];

    function ManageGameMatchSectionController( $scope, $state, ParseLinks, AlertService, PaginationUtil, paginationConstants, ThreadsBatchDelete,
                                               createThread, ThreadEditTop, ChangeThreadsColor, forumsGetAllThreadByState, SweetAlert) {
        var vm = this;
        vm.page = 1;
        // vm.selected = [];
        ...
        $scope.$watch('vm.refresh',function () {
            if (vm.refresh == 'manageGameMatchSection') {
                loadAll();
